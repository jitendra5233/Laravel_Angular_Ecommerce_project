            ...
            <div class="mb-3 col-md-12">
              ...
              <div class="row my-2" style="align-items: flex-end;"> 
                <div class="col-3">
                  ...
                  <input type="hidden" name="ameneties[]" id="ameneties"  value="" />
...
// var amArr = document.getElementById('ameneties').value;
amArr = [];
addAmRow = () =>{
  let amIcon = document.getElementById('ammIcon').value;
  let amText = document.getElementById('amText').value;
  $('#amList').append(`<li class="list-group-item" id=""><i class="${amIcon} fa-fw fa-solid"></i> ${amText}</li>`);
  amArr.push({
    id:amArr.length + 1,
    icon:amIcon,
    text:amText
  })
  document.getElementById('ameneties').value=amArr;
