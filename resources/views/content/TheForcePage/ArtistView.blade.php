...
@section('title', 'Artist - Performing Artist')
...
<h4 class="fw-bold py-3 mb-4">
  <span class="text-muted fw-light">Performing Artist </span>
</h4>
<div class="row">
  <div class="col-md-12">
    <div class="card mb-4">
      ...
      <div class="card-body">
          <div class="row">
            <div class="mb-3 col-md-12">
              <h5 class="card-header p-0 my-3"> Performing Artist</h5>
            </div>
...
handleSubmit = () =>
  {
        ...
        if (description.length < 1) {
          ...
          return false;
            ...
            axios.post('{{ENV("APP_URL")}}/updateArtist',data).then((result) => {
            if(result.data == 1)
            {
            Swal.fire(
                '',
                'Artist Page Update Successfully',
                'success'
            )
            .then((result) => {
              window.location.href = '{{ENV("APP_URL")}}/pages-performing_artist';
            });
            }
