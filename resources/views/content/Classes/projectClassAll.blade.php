...
<div class="row" style="align-items: center;">
  <div class="col-6">
    ...
    <h4 class="fw-bold py-3" style="margin:0">
      <span class="text-muted fw-light">Projects /</span> All Projects Classes
    </h4>
  </div>
  <div class="col-6" style="text-align:end">
    @if(session('role') == 'Admin')
    <div class="py-3">
      <a type="button" class="btn btn-primary" href="{{ url('projectClassAdd') }}">
        Create Class
      </a>
...
<div class="card">
  <h5 class="card-header">All Projects Classes</h5>
        ...
        <tr> 
          ...
          <td>
            <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
              <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" class="avatar avatar-xs pull-up" title="{{$row->classimg}}">
               <img  id="myImg" class="rounded-circle" src="{{ENV('APP_URL')}}/ProjectClassImages/{{$row->classimg}}" data-bigger-src="{{ENV('APP_URL')}}/ProjectClassImages/{{$row->classimg}}">
              </li>
            </ul>
          </td>
          ...
          <td>
            <div>
              <a href='{{ENV('APP_URL')}}/editClassProject/{{$row->id}}'>
              ...
              <a href='{{ENV('APP_URL')}}/projectClassView/{{$row->id}}'>
...
<script>
    ...
    if(e){
            $.ajax({
                type:'POST',
                url: '{{ENV("APP_URL")}}/api/changeProjectClassStatus',
                data:'id='+e,
