    ...
    <div class="col-md-12">
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
              ...
              <input type="hidden" name="projectid" id="projectid" value="{{$tableData->projectId}}" />
                  ...
                  <div class="mb-3 col-md-6">
                   ...
                   <div class="mb-3 col-md-6">
                    ...
                    <input class="form-control" type="text" id="page_title" name="page_title"  value="{{$tableData->page_title}}" />
                  </div>
                     <div class="mb-3 col-md-6">
                    <label for="exampleFormControlSelect1" class="form-label">Page Description</label>
                    <textarea id="page_description" name="page_description" class="form-control">{{$tableData->page_description}}</textarea>
                  </div>     
                  
                   <div class="mb-3 col-md-6">
                    <label for="exampleFormControlSelect1" class="form-label">Page Schema Json</label>
                    <textarea id="page_schema" name="page_schema" class="form-control">{{$tableData->page_schema}}</textarea>
                  </div>  
                  ...
                  <textarea id="short_description" name="short_description" class="form-control" > {{$tableData->short_description}}</textarea>
                </div>
  ...
  handleImages = () => {
    ...
    if (short_description.length < 1) {
      ...
      return false;
         ...
         Swal.fire({
            title: "Thankyou!",   
            text: "Sub Project Update Successfully !",   
            type: "success", 
