          ...
          <div class="row">
            ...
            <div class="mb-3 col-md-4">
              ...
              <div class="input-group input-group-merge">
                <input type="text" id="phone" name="phone" value="<?php
                  if($callback->purpose == 1){
                    echo 'Tentative';
                  }
                  if($callback->purpose == 2){
                    echo 'Owner';
                  }
                  if($callback->purpose == 3){
                    echo 'Buy';
                  }
                  if($callback->purpose == 4){
                    echo 'Sell';
                  }
                  if($callback->purpose == 5){
                    echo 'Other';
                  }
            ...
            <div class="mb-3 col-md-4">
             ...
             <?php if($callback->status == 1){?>
                <input type="text" id="phone" name="phone" value="Assigned" class="form-control" readonly/>
             <?php } ?>
             <?php if($callback->status == 2){?>
                <input type="text" id="phone" name="phone" value="Cancelled" class="form-control" readonly/>
             <?php } ?>
            </div>
            </div>
