...
@section('title', 'Online School - Online  School')
...
<h4 class="fw-bold py-3 mb-4">
  <span class="text-muted fw-light">Online School </span>
</h4>
<div class="row">
  <div class="col-md-12">
    <div class="card mb-4">
      ...
      <div class="card-body">
          <div class="row">
            <div class="mb-3 col-md-12">
              <h5 class="card-header p-0 my-3">Online School</h5>
            </div>
             ...
             <div class="mb-3 col-md-6">
                  ...
                  <div class="mb-3 col-md-6">
                   ...
                   <div class="mb-3 col-md-6">
                    ...
                    <img  id="myImg" class="" src="{{ENV('APP_URL')}}/OnlineSchoolImage/{{$row->banner_image}}" data-bigger-src="{{ENV('APP_URL')}}/OnlineSchoolImage/{{$row->banner_image}}" disabled />
                    </div>

                    <div class="mb-3 col-md-6">
                    <label for="exampleFormControlSelect1" class="form-label">Image *</label>
                    <img  id="myImg" class="" src="{{ENV('APP_URL')}}/OnlineSchoolImage/{{$row->image}}" data-bigger-src="{{ENV('APP_URL')}}/OnlineSchoolImage/{{$row->image}}" disabled />
                    </div>
...
handleSubmit = () =>
  {
        ...
        if (description.length < 1) {
          ...
          return false;
            ...
            axios.post('{{ENV("APP_URL")}}/updateOnlineSchool',data).then((result) => {
            if(result.data == 1)
            {
            Swal.fire(
                '',
                'Online School Page Update Successfully',
                'success'
            )
            .then((result) => {
              window.location.href = '{{ENV("APP_URL")}}/pages-school_banner';
            });
            }
