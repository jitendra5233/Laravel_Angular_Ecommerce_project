        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            ...
            <textarea class="form-control" type="text" id="addremark" name="remark"> </textarea>
                ...
                <div class="mb-3 col-md-6" id='datepickerInput'>
    ...
    userElement1.appendChild(option);
        ...
        if(appointmeant.length !=0){
         ...
         let fulldates = [];
          ...
          $('#datepickerInput').append('<input class="form-control" type="text" value="" readonly="readonly" id="datepicker" placeholder="Select Date">');
