    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
          <div class="row">
            ...
            <div class="mb-3 col-md-6">
              <label for="last_name" class="form-label">Purpose</label>
              <input class="form-control" type="text" name="email" id="email" value="{{$propertypurpose}}" readonly/>
            </div>
            <div class="mb-3 col-md-6">
              <label for="last_name" class="form-label">Property Location</label>
              <input class="form-control" type="text" name="email" id="email" value="{{$propertylocation}}" readonly/>
            </div>
            <div class="mb-3 col-md-6">
            ...
            <div class="mb-3 col-md-6">
             ...
             <div class="mb-3 col-md-6">
              <label class="form-label" for="phoneNumber">Contacted Date</label>
              <div class="input-group input-group-merge">
                <input type="text" id="phone" name="phone" value="{{$d}}" class="form-control" readonly/>
              </div>
             </div>
             <div class="mb-3 col-md-6">
              <label class="form-label" for="phoneNumber">Contacted Time</label>
              <div class="input-group input-group-merge">
                <input type="text" id="phone" name="phone" value="{{$t}}" class="form-control" readonly/>
              </div>
             </div>
             <div class="mb-3 col-md-4">
              <label class="form-label" for="phoneNumber">Appointment Date</label>
              <div class="input-group input-group-merge">
             ...
             <div class="mb-3 col-md-4">
              <label class="form-label" for="phoneNumber">Appointment Time</label>
              <div class="input-group input-group-merge">
