...
@section('title', 'Tables - All Career  List')
...
<div class="row" style="align-items: center;">
  <div class="col-6">
    ...
    <h4 class="fw-bold py-3" style="margin:0">
      <span class="text-muted fw-light">Career /</span> All Career
    </h4>
  </div>
...
<div class="card">
  <h5 class="card-header">All Career</h5>
...
Swal.fire({
  ...
  if (result.isConfirmed) {
    ...
    axios.post('{{ENV("APP_URL")}}/DeleteCareer',data).then((result) => {
      if(result.data == 1){
