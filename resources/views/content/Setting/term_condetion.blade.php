...
@section('title', 'Dashboard - Term and Conditions')
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card mb-4">
          <h5 class="card-header">Term and Conditions</h5>
          <!-- Account -->
          <!--<form action="{{ENV('APP_URL')}}/updateterm" method="post" onsubmit="return checkvalidate()">-->
            @csrf
          <div class="card-body">
              <div class="row">
                  <div class="mb-3 col-md-12">
                    <label for="description" class="form-label">Term Conditions</label>
...
$(document).ready(function() {
    ...
    checkvalidate = () =>{
        ...
        data.append('term_condetion',inp_htmlcode);
        $(".error").remove();
    ...
    axios.post('{{ENV("APP_URL")}}/updateterm',data).then((result) => {
     if(result.data == 1){
          Swal.fire(
            'Thankyou!',
            'Term & Condetion Update Successfully !',
            'success',
            ).then((result) => {
             location.reload();
             });
