...
@section('title', 'Tables - View Pyament History')
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card mb-4">
          <h5 class="card-header">View Payment History</h5>
          <div class="card-body">
              <div class="row">
              ...
              <div class="mb-3 col-md-6">
                  ...
                  <?php } ?>
                  <?php if($row->packageName !=''){ ?>

                  <div class="mb-3 col-md-6">
                    <label for="packageName" class="form-label">Package Name *</label>
                    <input class="form-control" type="text" id="packageName" name="packageName"  value="{{$row->packageName}}" disabled/>
                  </div>
                  <?php } ?>
                  ...
                  <div class="mb-3 col-md-6">
                    ...
                    <input class="form-control" type="text" id="payment_id" name="payment_id"  value="{{$row->payment_id}}" disabled/>
                  </div>
                  
                    <div class="mb-3 col-md-6">
                    <label for="payment_id" class="form-label">Payment Date/Time *</label>
                    <input class="form-control" type="text" id="payment_id" name="payment_id"  value="{{$row->created_at}}" disabled/>
                  </div>
                  
                  
                  
                  <div class="mb-3 col-md-6">
                    <label for="payment_intent_id" class="form-label">Payment Intent Id *</label>
                    <input class="form-control" type="text" id="payment_intent_id" name="payment_intent_id"  value="{{$row->payment_intent_id}}" disabled/>
                  </div>
                </div>
