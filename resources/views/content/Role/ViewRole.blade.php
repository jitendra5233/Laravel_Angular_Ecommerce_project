          ...
          <div class="card-body">
              <div class="row">
                  <div class="mb-3 col-md-6">
                    ...
                    <input class="form-control" type="text" id="roleName" name="roleName" value="{{$row->name}}" <?php echo ( $row->name =="Agent" ? 'disabled' : ( $row->name =="Blogger" ? 'disabled' : '' ) ) ?>/>
                  </div>
              </div>
          </div>
          <hr class="my-0">
...
$(document).ready(function(){
  ...
  $("#b2").click(function(){
    ...
    if((p1 == false && p2 == false && p3== false  && p4== false)  &&  (b1 == false  && b2 == false && b3== false && b4== false))
    {
       $('#message').after('<span class="error">please Check Atleat One Check box*</span>');
       return false;
    }
