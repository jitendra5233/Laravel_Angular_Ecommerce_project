          ...
          <div class="card-body">
              <div class="row">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="mt-4">
                        <button type="submit" class="btn btn-primary me-2" onclick="handleAddRole()">Save changes</button>
...
$(document).ready(function(){
  ...
  $("#b2").click(function(){
    ...
    $('#roleName').after('<span class="error">This field is required*</span>');
    spinner.hide();
    return false;
    }
    if((p1 == false)  &&  (b1 == false))
    {
        $('#message').after('<span class="error">Please Check Atleat One Check box from View Type  Checkbox*</span>');
    spinner.hide();
    return false;
    }
        ...
        axios.post('{{ENV("APP_URL")}}/submit-role',data).then((result) => {
            if(result.data == 1){
                spinner.hide();
