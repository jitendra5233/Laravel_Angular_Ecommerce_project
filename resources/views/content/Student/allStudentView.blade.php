...
@section('title', 'Tables - All Students List')
...
<div class="row" style="align-items: center;">
  <div class="col-6">
    ...
    <h4 class="fw-bold py-3" style="margin:0">
      <span class="text-muted fw-light"></span>Students / Parents
    </h4>
  </div>
...
<div class="card">
  <h5 class="card-header">All Students / Parents </h5>
  ...
  <table class="table" id="example" class="table display">
      ...
      <tbody class="table-border-bottom-0" id="mydata">
        ...
        <tr>
          ...
          <td>{{$row->email}}</td>
          <td>{{$row->phone}}</td>
          <td><?php echo $row->type == 1 ? "Student" :"Parent" ?></td>
          <td>
            <a href='{{ENV('APP_URL')}}/getSingleStudent/{{$row->id}}'>
