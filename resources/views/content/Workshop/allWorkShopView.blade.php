...
@section('title', 'Tables - workshop List')
...
<div class="row" style="align-items: center;">
  <div class="col-6">
    ...
    <h4 class="fw-bold py-3" style="margin:0">
      <span class="text-muted fw-light">Workshop /</span> All Workshop
    </h4>
  </div>
...
<div class="card">
  <h5 class="card-header">All Workshop</h5>
  ...
  <table class="table" id="example" class="table display">
      ...
      <tbody class="table-border-bottom-0" id="mydata">
        ...
        <tr>
          ...
          <td>{{$row->projectClassName}}</td>
          <td>{{$row->branchName}}</td>
          <td>
          @foreach($row->workshopdates as $row2)
          <?php echo  date('d-M', strtotime($row2)); ?>
          @endforeach
        </td>
          ...
          <td>
            <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
              <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" class="avatar avatar-xs pull-up" title="{{$row->image}}">
               <img  id="myImg" class="rounded-circle" src="{{ENV('APP_URL')}}/WorkshopImage/{{$row->image}}" data-bigger-src="{{ENV('APP_URL')}}/WorkshopImage/{{$row->image}}"
>
              </li>
            </ul>
          </td>
          ...
          <td>
            <div>
              <a href='{{ENV('APP_URL')}}/editWorkshop/{{$row->id}}'>
              ...
              <a href='{{ENV('APP_URL')}}/workshopView/{{$row->id}}'>
